...
VMWARE_FOLDER=OCP4B
CLUSTER_NAME=ocp4b
CLUSTER_FOLDER=/vms/clusters/ocp4c
...
govc folder.create "/CHIARETTO/vm/${VMWARE_FOLDER}"

# Import OVA
log "Importing ova"
govc import.ova --ds=SSD --pool=/CHIARETTO/host/HOME/Resources --name=${CLUSTER_ID}-rhcos https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/${OPENSHIFT_VERSION}/latest/rhcos-vmware.x86_64.ova || err "Error when importing OVA"
...
govc vm.clone -vm=$TEMPLATE -ds=SSD -folder=${VMWARE_FOLDER} -pool=/CHIARETTO/host/HOME/Resources ${VM_NAME}
